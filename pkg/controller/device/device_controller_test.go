...
func TestReconcile(t *testing.T) {
	...
	instance := &packetnetv1alpha1.Device{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the Device object and expect the Reconcile and Deployment to be created
